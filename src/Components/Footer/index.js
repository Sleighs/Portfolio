  ...
  return(
    <footer id="footer-container" className="container">
      <div className="footer-icons">
        ...
        <a className={`footer-info-link`} style={{marginRight: 16,display: 'none',}} target="_blank" href="tel:6094722897" rel="noreferrer">
        ...
        <a className={`footer-info-link`} style={{marginRight: 16,}} target="_blank" href="http://github.com/sleighs" rel="noreferrer">
        ...
        <a className={`footer-info-link`} target="_blank" href="https://www.linkedin.com/in/samuelwrightdev/" rel="noreferrer">
