  ...
  return(
    <footer id="footer-container">
      <div className="footer-icons">
        <a className={`footer-info-link`} style={{marginRight: 18,}} target="_blank" href="mailto:swrightdev@gmail.com" rel="noreferrer">
        ...
        <a className={`footer-info-link`} style={{marginRight: 16,}} target="_blank" href="tel:6094722897" rel="noreferrer">
